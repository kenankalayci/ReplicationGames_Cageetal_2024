...
Kalayci, Kenan: University of Queensland. E-mail: \href{mailto:k.kalayci@uq.edu.au}{k.kalayci@uq.edu.au}.
...
\author{Andriyanto, Nicolas Eugster, Guan-Jia Huang, Kenan Kalayci}
...
% Note: Figures 2a, 2b, and 3 from the original paper can be reproduced
% by running the replication_master.do file in the replication package.
% The code generates Figure2a.pdf, Figure2b.pdf, and Figure3.pdf.
\textit{Figures 2a, 2b, and 3 to be included upon running the Stata replication code. The relevant do-files generate Figures~2a (candidate-level determinants of firm donations), 2b (amount of firm donations), and~3 (campaign revenue composition in 1993 and 1997).}
...
\textit{Appendix figures to be included upon running the Stata replication code.}
...
Here we paste the main tables from the original study for comparison of replicated results in Section 6.  

\begin{table}[htbp]\centering
\caption{Table 3 (original study): Impact of corporate donations on campaign communication}
\resizebox{\textwidth}{!}{
\begin{tabular}{lccccc}
\hline\hline
 & Local index & Local references & National references & Left-right score & Extremeness \\
 & (1) & (2) & (3) & (4) & (5) \\
\hline
...
\begin{flushleft}
\footnotesize Notes: Robust standard errors in parentheses. \\
...
\begin{table}[htbp]\centering
\caption{Table 4 (original study): Impact of corporate donations on broad policy topics}
\resizebox{\textwidth}{!}{
\begin{tabular}{lcccc}
\hline\hline
 & Economy & Social & Homeland and administration & Foreign policy \\
 & (1) & (2) & (3) & (4) \\
\hline
...
\begin{table}[htbp]\centering
\caption{Table 5 (original study): Heterogeneity by party}
\resizebox{\textwidth}{!}{
\begin{tabular}{lccccc}
\hline\hline
 & Local index & Local references & National references & Left-right score & Extremeness \\
...
\begin{table}[htbp]\centering
\caption{Table 6 of original study: Heterogeneity by sources of funding and type of donors}
\resizebox{\textwidth}{!}{
\begin{tabular}{lcccc}
\hline\hline
 & \multicolumn{4}{c}{Local index} \\
 & (1) & (2) & (3) & (4) \\
\hline
...
\begin{table}[htbp]\centering
\caption{Table 7 of original study: Impact of corporate donations on legislative activity and discourse}

% -------- Panel (a) -------- %
\subsection*{(a) Written questions to the government}
\resizebox{\textwidth}{!}{
\begin{tabular}{lcccc}
\hline\hline
 & Number of questions & Local index & Local references & National references \\
 & (1) & (2) & (3) & (4) \\
\hline
...
% -------- Panel (b) -------- %
\vspace{1em}
\subsection*{(b) Debate interventions}
\resizebox{\textwidth}{!}{
\begin{tabular}{lcccc}
\hline\hline
 & Number of interventions & Local index & Local references & National references \\
 & (1) & (2) & (3) & (4) \\
\hline
