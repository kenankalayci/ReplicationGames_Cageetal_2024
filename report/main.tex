...
%
 \thanks{
Authors:
Andriyanto: University of Queensland. E-mail: \href{mailto:andriyanto@uq.edu.au}{andriyanto@uq.edu.au}.
...
Kalaycı, Kenan: University of Queensland. E-mail: \href{mailto:k.kalayci@uq.edu.au}{k.kalayci@uq.edu.au} (corresponding author).
...
\begin{spacing}{1.5}
We used the replication package here: \href{https://www.openicpsr.org/openicpsr/project/184946/version/V1/view}{OpenICPSR replication package}. 
...
\footnotesize
\justifying
\textit{Notes}: Standard errors in parentheses; \textit{p}-values in brackets. $^{*}$ \(p<0.10\), $^{**}$ \(p<0.05\), $^{***}$ \(p<0.01\).
Panel~A uses the original sample.
