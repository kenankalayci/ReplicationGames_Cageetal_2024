...
winsor2 std_dons_firms, cuts(5 95) replace
...
esttab indiv_1 indiv_2 indiv_3 using "$main/Table3win5.txt", ///
...
esttab indiv_1 indiv_2 indiv_3 indiv_4 using "$main/Table4.tex", ///
replace keep(std_dons_firms)  ///
b(3) se lab nomtitles ///
unstack style(tex) lines compress star(* 0.10 ** 0.05 *** 0.01) nonotes ///
...
esttab m_* using "$main/Table5.tex", ///
